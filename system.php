 ...
 */
function toResponseSuccess($actionInfo, $pld = null){
 ...
 * @param String $err
 */
function toResponseError($actionInfo, $errcode = 5000, $errmsg = 'Action Execute Exception !'){
	$response->cod = $actionInfo->cod;
	$response->res = false;
	...
	echo $responsestr;
	log_debug("response error ".$responsestr);
	exit();
}
